"""
Django settings for wirktools project.
...
SECRET_KEY = 'django-insecure-^dnx5fde%210%oozxo136qdmc4^f6)xewhzbi!lvt0d=h)u7k='
...
CORS_ALLOW_ALL_ORIGINS = True  # Esto es para desarrollo, para producción especifica los dominios permitidos
